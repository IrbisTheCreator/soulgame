...
func main() {
	addr := flag.String("addr", ":443", "Сетевой адрес HTTP")
	...
	dsn := flag.String("dsn", "user=postgres password=200670 dbname=soulgame sslmode=disable", "Параметры подключения к бд")
	flag.Parse()
